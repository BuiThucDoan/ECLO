export const instructionDetailERP = [
    ...
    steps: [
      ...
      },
      {
        ...
        <img src='https://res.cloudinary.com/dzh4pimvj/image/upload/v1722237816/Untitled83_lddpos.png' alt='Chọn chấm công cần xóa'>
        \n<b>Bước 2:</b> Chọn biểu tượng thùng rác
        \nTrong menu tùy chọn, nhấn vào biểu tượng thùng rác <b>🗑</b> để bắt đầu quá trình xóa chấm công.<br/>
        <img src='https://res.cloudinary.com/dzh4pimvj/image/upload/v1722237952/Untitled83_yozjsu.png' alt='Chọn loại biểu tượng thùng rác để thực hiện xóa chấm công'>
        \n<b>Bước 4:</b> Xác nhận xóa
        \nHệ thống sẽ hiển thị thông báo: "Bạn có thật sự muốn thực hiện thao tác này ?"<br/>
        <img src='https://res.cloudinary.com/dzh4pimvj/image/upload/v1722238329/Untitled83_jlglct.png' alt='Hiển thị thông báo yêu cầu người dùng xác nhận xóa'>
        \nNếu bạn chọn <b>"OK"</b>, hệ thống sẽ xử lý yêu cầu và thông báo <b><span style="color: green;">"Cập nhật thành công"</span></b>. Chấm công sẽ được xóa khỏi cơ sở dữ liệu.<br/>
        <img src='https://res.cloudinary.com/dzh4pimvj/image/upload/v1722238171/Untitled83_u8l1vq.png' alt='Xóa chấm công thành công'>
    ...
    },
    {
      ...
      steps: [
        ...
        },
        {
          ...
          <img src='https://res.cloudinary.com/dzh4pimvj/image/upload/v1722239269/Untitled83_wd8w3w.png' alt='Chọn IP bị chặn cần sửa'>
          \n<b>Bước 2:</b> Mở form chỉnh sửa
          \nSau khi chọn IP bị chặn, nhấn vào dấu <b>"..."</b> nằm bên phía bên phải. Sau đó, chọn <b>"Sửa"</b> để bắt đầu.<br/>
          <img src='https://res.cloudinary.com/dzh4pimvj/image/upload/v1722239328/Untitled83_ipenmm.png' alt='Chọn biểu tượng cây viết để mở form chỉnh sửa'>
          \n<b>Bước 3:</b> Cập nhật thông tin
          \nTrong form chi tiết, cập nhật các thông tin mà bạn muốn thay đổi như IP, nội dung, trạng thái.
          \nĐảm bảo rằng các thông tin mới được nhập chính xác và đầy đủ.<br/>
          <img src='https://res.cloudinary.com/dzh4pimvj/image/upload/v1722239391/Untitled83_wntue7.png' alt='Nhập thông tin thay đổi vào form'>
          \n<b>Bước 4:</b> Lưu thay đổi
          \nSau khi đã cập nhật xong thông tin, nhấn nút <b>"Hoàn tất"</b> để lưu các thay đổi.
          \nHệ thống sẽ xử lý và thông báo <b><span style="color: green;">"Cập nhật thành công"</span></b>.<br/>
          <img src='https://res.cloudinary.com/dzh4pimvj/image/upload/v1722239443/Untitled83_rclxdx.png' alt='Thông báo cập nhật thông tin thành công'>
        ...
        },
        {
          ...
          <img src='https://res.cloudinary.com/dzh4pimvj/image/upload/v1722239528/Untitled83_shanaq.png' alt='Chọn IP bị chặn cần xóa'>
          \n<b>Bước 2:</b> Mở menu tùy chọn
          \nNhấn vào biểu tượng ba gạch ngang <b>≡</b> bên dưới góc phải để mở menu tùy chọn.<br/>
          <img src='https://res.cloudinary.com/dzh4pimvj/image/upload/v1722239559/Untitled83_nt1dpt.png' alt='Chọn loại biểu tượng để thực hiện xóa IP bị chặn'>
          \n<b>Bước 3:</b> Chọn biểu tượng thùng rác
          \nTrong menu tùy chọn, nhấn vào biểu tượng thùng rác <b>🗑</b> để bắt đầu quá trình xóa IP bị chặn.<br/>
          <img src='https://res.cloudinary.com/dzh4pimvj/image/upload/v1722239617/Untitled83_jn9vrz.png' alt='Chọn loại biểu tượng thùng rác để thực hiện xóa IP bị chặn'>
          \n<b>Bước 4:</b> Xác nhận xóa
          \nHệ thống sẽ hiển thị thông báo: "Bạn có muốn xóa ?"<br/>
          <img src='https://res.cloudinary.com/dzh4pimvj/image/upload/v1722239672/Untitled83_inb2is.png' alt='Hiển thị thông báo yêu cầu người dùng xác nhận xóa'>
          ...
          <img src='https://res.cloudinary.com/dzh4pimvj/image/upload/v1722239710/Untitled83_t04jb4.png' alt='Xóa IP bị chặn thành công'>
          \n<div style='color:black;border-left: 2px solid green; margin-top: 3px; padding-left: 15px;'>Nếu bạn chọn <b>"Hủy"</b>, hệ thống sẽ quay trở lại trang ban đầu mà không thực hiện xóa.</div>`,
        },
      ],
    },
    ...
    },
    {
      ...
      steps: [
        ...
        },
        {
          ...
          \n<b>Bước 3:</b> Chọn biểu tượng thùng rác
          \nTrong menu tùy chọn, nhấn vào biểu tượng thùng rác <b>🗑</b> để bắt đầu quá trình xóa nhảy ca.<br/>
      ...
      steps: [
        {
          ...
          \n<b>Kết thúc công việc: </b>bạn có thể chọn kích hoạt hoặc không kích hoạt thời hạn kết thúc công việc.  Nếu kích hoạt, hệ thống sẽ hiển thị khung để  bạn nhập số ngày sẽ khóa khi kết thúc.
    ...
    },
    {
      ...
      label: 'HƯỚNG DẪN SỬ DỤNG TRANG ĐỀ XUẤT',
      steps: [
        {
          id: 351,
          label: '1. Thêm đề xuất',
          description: `<b>Bước 1:</b> Truy cập vào chức năng thêm đề xuất
          \nĐầu tiên, trên giao diện của trang đề xuất, bạn nhìn vào phần dưới cùng bên phải giao diện để tìm thấy biểu tượng <b>≡</b>.     
          \nNhấp vào biểu tượng này để mở menu tùy chọn.<br/>
          <img src='https://res.cloudinary.com/dzh4pimvj/image/upload/v1722170118/10a7ccdf-9f0f-4b5a-9bac-45a34221539e.png'>
          \n<b>Bước 2:</b> Chọn thêm đề xuất
          \nTrong menu tùy chọn, bạn nhấp vào biểu tượng dấu cộng <b>+</b>.
          \nHệ thống sẽ mở ra một form thêm đề xuất mới để bạn điền thông tin.<br/>
          <img src='https://res.cloudinary.com/dzh4pimvj/image/upload/v1722170234/b23855b4-9db1-47e4-884c-3b7f9444ec64.png'>
          \n<b>Bước 3:</b> Nhập thông tin cấu hình hình thức
          \nTại đây, bạn cần nhập các thông tin sau:
          \n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; • <b>Đề xuất:</b> Chọn tiêu đề của đề xuất. Đây là tên gọi của đề xuất mà bạn đang tạo.
          \n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; • <b>Hình thức:</b> Chọn loại hình tương ứng với đề xuất.
          \n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; • <b>Quy trình:</b> Chọn quy trình hoặc giai đoạn mà đề xuất này sẽ trải qua.
          \n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; • <b>Hạng mục:</b> Chọn hạng mục phù hợp cho đề xuất, giúp phân loại và dễ quản lý hơn.
          \n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; • <b>Mục tiêu:</b> Nhập mục tiêu hoặc kết quả mong muốn từ đề xuất này.
          \n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; • <b>Ngày dự kiến:</b> Chọn ngày dự kiến triển khai đề xuất.
          \n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; • <b>Số tiền:</b> Nhập tổng số tiền dự toán cho đề xuất này.
          \n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; • <b>Số tiền đã bao gồm VAT:</b> nếu số tiền đã bao gồm VAT thì hãy tích vào ô vuông bên cạnh.
          \n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; • <b>VAT:</b> Nhập phần trăm VAT áp dụng.
          \n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; • <b>Thành tiền VAT:</b> Hệ thống sẽ tự động tính toán số tiền VAT dựa trên tỷ lệ bạn nhập
          \n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; • <b>Khách hàng:</b> Chọn khách hàng hoặc đối tượng liên quan đến đề xuất này.
          \n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; • <b>Tên cá nhân:</b> Nhập tên cá nhân chịu trách nhiệm hoặc liên quan trực tiếp đến đề xuất.
          \n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; • <b>Dự án:</b> Chỉ định dự án mà đề xuất này thuộc về.
          \n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; • <b>Chương trình sản xuất:</b> Chọn chương trình sản xuất liên quan.
          \n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; • <b>Nhân viên:</b> Chọn nhân viên hoặc nhóm nhân viên sẽ thực hiện hoặc theo dõi đề xuất này.
          \n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; • <b>Nhà cung cấp:</b> Chọn nhà cung cấp liên quan đến đề xuất, nếu có.
          \n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; • <b>Gắn kèm đề xuất: </b>Đính kèm các đề xuất khác.
          \n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; • <b>Chứng từ:</b> Đính kèm các chứng từ cần thiết để hỗ trợ và minh chứng cho đề xuất.
          \n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; • <b>Ghi chú:</b> Thêm bất kỳ ghi chú hoặc nhận xét bổ sung nào liên quan đến đề xuất.
          \n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; • <b>Tags:</b> Thêm các thẻ để dễ dàng phân loại và tìm kiếm đề xuất sau này.
          \n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; • <b>Chi tiết đề xuất</b>
          \nNhấn <b>"Thêm"</b> để thêm các mục chi tiết cho đề xuất. 
          \nĐiền các thông tin cần thiết như nội dung, số tiền, số lượng, đơn vị, tổng số tiền, và ghi chú cho từng mục. Sau đó nhấn chọn “Hoàn tất” để lưu chi tiết đề xuất hoặc “Hủy” để quay lại mà không thực hiện thay đổi nào.<br/>
          <img src='https://res.cloudinary.com/dzh4pimvj/image/upload/v1722170932/d2f9eff7-ad0d-40a1-8e79-2315e772f2bf.png'>
          <div style='color:black;border-left: 2px solid green; margin-top: 3px; padding-left: 15px;'>Mỗi bước thực hiện của bạn sẽ được lưu vào bản nháp. Bạn có thể chọn nút <span style='color: red'>"Xóa bản nháp"</span> để không lưu bất cứ hành động nào khi hủy đề xuất.</div>
          \n<b>Bước 4:</b> Hoàn tất thêm đề xuất
          \nSau khi điền đầy đủ thông tin, nhấn vào nút <b>"Gửi đề xuất"</b> để lưu thông tin đề xuất mới.
          \nHệ thống sẽ xử lý và thông báo <b><span style="color: green;">"Cập nhật thành công"</span></b>.<br/>
          <div style='color:black;border-left: 2px solid green; margin-top: 3px; padding-left: 15px;'>Nhân viên chỉ có quyền xem đề xuất, chỉ có các tài khoản có quyền duyệt đề xuất như giám đốc, giám đốc nhân sự mới có thể duyệt đề xuất.</div>`,
        },
        {
          id: 352,
          label: '2. Xóa đề xuất nháp',
          description: `<b>Bước 1:</b> Chọn đề xuất nháp cần xóa
          \nTruy cập vào danh sách đề xuất nháp cần xóa trên hệ thống.
          \nTìm và chọn đề xuất nháp mà bạn muốn xóa.<br/>
          <img src='https://res.cloudinary.com/dzh4pimvj/image/upload/v1722172683/be94cb8e-ca7a-47d2-b2a8-e3c6ef4f21a1.png'>
          \n<b>Bước 2:</b> Mở menu tùy chọn
          \nNhấn vào biểu tượng ba gạch ngang <b>≡</b> bên dưới góc phải để mở menu tùy chọn.<br/>
          <img src='https://res.cloudinary.com/dzh4pimvj/image/upload/v1722172722/93397ed1-6508-44dc-84c0-f52777a6d027.png'>
          \n<b>Bước 3:</b> Chọn biểu tượng thùng rác
          \nTrong menu tùy chọn, nhấn vào biểu tượng thùng rác <b>🗑</b> để bắt đầu quá trình xóa đề xuất nháp.<br/>
          <img src='https://res.cloudinary.com/dzh4pimvj/image/upload/v1722172774/ece81869-a66d-497c-ab1a-aef2ab2b2190.png'>
          \n<b>Bước 4:</b> Xác nhận xóa
          \nHệ thống sẽ hiển thị thông báo: "Bạn có muốn xóa ?"<br/>
          <img src='https://res.cloudinary.com/dzh4pimvj/image/upload/v1722172806/a8320c5a-46d6-4568-ad73-da59a3597349.png' >
          \nNếu bạn chọn <b>"Đồng ý"</b>, hệ thống sẽ xử lý yêu cầu và thông báo <b><span style="color: green;">"Cập nhật thành công"</span></b>. Đề xuất nháp sẽ được xóa khỏi cơ sở dữ liệu.<br/>
          <img src='https://res.cloudinary.com/dzh4pimvj/image/upload/v1722172837/6f334cb7-2aa2-459d-a3e8-95377dce32da.png'>
          \n<div style='color:black;border-left: 2px solid green; margin-top: 3px; padding-left: 15px;'>Nếu bạn chọn <b>"Hủy"</b>, hệ thống sẽ quay trở lại trang ban đầu mà không thực hiện xóa.</div>`,
        },
      ],
    },
      ...
      steps: [
        {
          ...
          \n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; • <b>Tags:</b> Thêm các thẻ để dễ dàng phân loại và tìm kiếm đề xuất sau này.
          \n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; • <b>Chi tiết đề xuất</b>
          \n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Nhấn "Thêm" để thêm các mục chi tiết cho đề xuất. 
          \n&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Điền các thông tin cần thiết như nội dung, số tiền, số lượng, đơn vị, tổng số tiền, và ghi chú cho từng mục. Sau đó nhấn chọn “Hoàn tất” để lưu chi tiết đề xuất hoặc “Hủy” để quay lại mà không thực hiện thay đổi nào.<br/>
          <img src='https://res.cloudinary.com/dzh4pimvj/image/upload/v1722170932/d2f9eff7-ad0d-40a1-8e79-2315e772f2bf.png'>
          <div style='color:black;border-left: 2px solid green; margin-top: 3px; padding-left: 15px;'>Mỗi bước thực hiện của bạn sẽ được lưu vào bản nháp. Bạn có thể chọn nút <span style='color: red'>"Xóa bản nháp"</span> để không lưu bất cứ hành động nào khi hủy đề xuất.</div>
          \n<b>Bước 4:</b> Hoàn tất thêm đề xuất
    ...
    {
      id: 36,
      link: 'huong-dan-su-dung-trang-danh-gia-cong-viec',
      label: 'HƯỚNG DẪN SỬ DỤNG TRANG ĐÁNH GIÁ CÔNG VIỆC',
      steps: [
        {
          id: 361,
          label: 'Thêm đánh giá công việc',
          description: `<b>Bước 1:</b> Truy cập vào chức năng thêm đánh giá công việc
          \nĐầu tiên, trên giao diện của trang đánh giá công việc, bạn nhìn vào phần dưới cùng bên phải giao diện để tìm thấy biểu tượng <b>≡</b>.     
          \nNhấp vào biểu tượng này để mở menu tùy chọn.<br/>
          <img src='https://res.cloudinary.com/dzh4pimvj/image/upload/v1722236183/5742f0f9-7a8a-4e43-8a6b-18bafc0237e8.png'>
          \n<b>Bước 2:</b> Chọn thêm đánh giá công việc
          \nTrong menu tùy chọn, bạn nhấp vào biểu tượng dấu cộng <b>+</b>.
          \nHệ thống sẽ mở ra một form thêm đánh giá công việc mới để bạn điền thông tin.<br/>
          <img src='https://res.cloudinary.com/dzh4pimvj/image/upload/v1722236219/29e3fd3b-05f0-475b-9e7f-f67d770049bd.png'>
          \n<b>Bước 3:</b> Nhập thông tin công việc cần đánh giá:
          \nTại đây, bạn cần nhập công việc chính hoặc công việc phụ vào khung tìm kiếm, hệ thống sẽ hiển thị gợi ý các công việc cần đánh giá.<br/>
          <img src='https://res.cloudinary.com/dzh4pimvj/image/upload/v1722236467/5e8b1500-761e-4f15-b8f3-f2acbd573a57.png'>
          \nSau khi chọn công việc, hệ thống sẽ hiển thị thông tin chi tiết của công việc. Bạn cần nhập Điểm đề xuất và nội dung để gửi đến giám đốc hoặc người quản lý để xem xét và duyệt.<br/>
          <img src='https://res.cloudinary.com/dzh4pimvj/image/upload/v1722236772/328d2eef-e175-4ddb-b606-eb115326080c.png'>
          <div style='color:black;border-left: 2px solid green; margin-top: 3px; padding-left: 15px;'>Đánh giá công việc sẽ được gửi đến giám đốc hoặc người quản lý để xem xét và duyệt.</div>
          <b>Bước 4:</b> Hoàn tất thêm đánh giá công việc
          \nSau khi điền đầy đủ thông tin, nhấn vào nút <b>"Hoàn tất"</b> để lưu thông tin đánh giá công việc mới.
          \nHệ thống sẽ xử lý và thông báo <b><span style="color: green;">"Cập nhật thành công"</span></b>.<br/>
          <div style='color:black;border-left: 2px solid green; margin-top: 3px; padding-left: 15px;'>Nhân viên chỉ có quyền xem đánh giá công việc, chỉ có các tài khoản có quyền duyệt đánh giá công việc như giám đốc, giám đốc nhân sự, quản lý mới có thể duyệt đánh giá công việc.</div>`,
        },
      ],
    },
  ];
